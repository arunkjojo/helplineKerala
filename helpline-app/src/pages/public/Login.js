  ...
  loginForm = (e)=>{
    ...
    // eslint-disable-next-line react-hooks/rules-of-hooks
      if(dat.password.length < 8){
        ...
        if (!navigator.onLine) {
          toastr.warning("No Internet Connection, Login is not support, Please Check Your Internet Connection", "Application is Offline Mode");
        }else{
    ...
    return(
      <div className="container">
        <form className="form-group">
          ...
          <div className="form-group">
            <Button variant="contained" color="primary" onClick={this.loginForm} className="form-control btn btn-success">Login</Button>
          </div>
        </form>
        <div className="container">
